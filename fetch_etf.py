...
_YLD_PENDING = {
    # 以下 2026-07-07 多源查證（Yahoo/yfinance/TWSE calendar）確認仍未配息
    "00949",    # 復華日本龍頭，年配(10月)，2024-07-01 上市，2026-09-23 再查仍查無配息
    "00954",    # 中信日本半導體，年配，2024-08-20 上市，2026-09-23 再查仍查無配息
    "00965",    # 元大航太防衛，年配，2025 上市，2026-09-23 再查仍查無配息
    "009800",   # 中信NASDAQ，年配(11月)，2025-02-11 上市，經理人得決定不配，2026-09-23 再查仍查無配息
    "00983A",   # 主動中信ARK創新，年配，2025-06-18 上市，2026-09-23 再查仍查無配息
    "009824",   # 群益美國科技巨頭，季配，2026-06-25 上市，成立滿45日後才配息（最早9月）
    "00408A",   # 主動第一金優股息，季配(1/4/7/10)，2026-07-15 上市，成立滿60日才配息，首配預估2026-10（2026-07-21 用戶提供+WebSearch核實）
    "00985A",   # 主動野村台灣50，半年配，2025-07-21 上市，評價日月份未公開；MoneyDJ/Win投資查無配息紀錄（2026-07-29 用戶提供+WebSearch核實）；2026-09-23 MoneyDJ basic0005 複查仍查無配息
    "009811",   # 統一美國50，半年配(評價日3月底/9月底，配息月4/10)，2025-07-29 上市，首次評價2026-03底但至今未配（2026-07-29 用戶提供+WebSearch核實）；2026-09-23 MoneyDJ basic0005 複查仍查無配息
    "009810",   # 玉山全球藍籌100，年配(12月)，2025-07-16 上市，首次評價日為成立後180日，首次除息預計2026-12（2026-08-07 用戶提供+WebSearch核實）；2026-09-23 MoneyDJ basic0005 複查仍查無配息
    "00986A",   # 主動台新龍頭成長，年配(評價日10/31，除息11月，發放12月)，2025-08-27 上市，首配預計2026-11（2026-08-07 用戶提供+WebSearch核實）；2026-09-23 MoneyDJ basic0005 複查仍查無配息
    ...
    "009827",   # 玉山未來全球算力，季配（3/6/9/12月底評價、評價後45個營業日內發放），2026-08-24 成立、09-02 上市，尚未配息（2026-09-11 用戶提供 + MoneyDJ 核實）
}
